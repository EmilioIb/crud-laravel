<header class="bg-gray-700 sticky top-0 z-50" x-data="dropdown()">
        <div class="container flex items-center h-16 justify-between md:justify-start">
            <a 
            x-on:click = "show()"
            class="flex flex-col items-center justify-center order-last md:order-first px-6 md:px-4 bg-white bg-opacity-25 text-white font-semibold h-full cursor-pointer">
        ...
        {{-- Desktop menu --}}
            ...
            <div class="overflow-y-auto bg-white h-full">
                ...
                <p class="text-write-500 my-3 px-6 text-sm flex items-center">USERS</p>
                @auth
